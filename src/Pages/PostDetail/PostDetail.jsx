...
const PostDetail = () => {
    ...
    faq: [
      {
        ...
        answer: `
          There are two main types of abortion: medical and surgical. Medical abortion involves the use of
          medications to terminate a pregnancy, typically within the first 10 weeks. Surgical abortion involves
          a minor procedure to remove the pregnancy from the uterus. The type of abortion chosen can depend on
          various factors including gestational age and medical history.
        `,
      },
      {
        question: "Is abortion safe?",
        answer: `
          Abortion is considered safe when performed by trained healthcare providers using approved methods.
          The risks associated with abortion are generally lower than those associated with childbirth, especially
          when performed in the early stages of pregnancy. It is important to seek care from reputable providers
      ...
      },
      {
        ...
        answer: `
          It is crucial to have support when considering an abortion. This can include talking to a healthcare
          provider, seeking counseling services, or joining support groups. Many organizations provide confidential
          and non-judgmental support to help individuals navigate their options and make informed decisions.
        `,
      },
    ],
  };
  ...
  return (
    <div className="bg-[#efeee7] w-full space-y-6">
      <div className="max-w-4xl mx-auto p-6 space-y-4  bg-[#efeee7]">
